...
if (isset($_POST["save"])) {
   ...
   $written_by = $_POST["written_by"];
    $pdf = $_FILES["pdf"]['name'];
   $temp_name1 = $_FILES['pdf']['tmp_name'];
   move_uploaded_file($temp_name1,"libary/$pdf");
   $insert_books = "INSERT into books(book_name,book_subject,written_by,pdf_file)values('$book_name','$book_subject','$written_by','$pdf')";
        ...
        <div class="dashboard-page-one">
           ...
           <?php
            ...
            <div class="dashboard-content-one">
                    ...
                    <div class="card-body">
                        ...
                        <form class="new-added-form" method="POST" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Subject *</label>
                                    <input type="text" placeholder="" class="form-control" name="book_subject">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Writter Name *</label>
                                    <input type="text" placeholder="" class="form-control" name="written_by">
                                </div>
                                <!-- <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Class *</label>
                ...
                $employee_books = mysqli_query($con,$select_books);
                ?>
                <div class="card height-auto">
                    <div class="card-body">
                        <div class="heading-layout1">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php
                    while ($row = mysqli_fetch_array($employee_books)) {
                        echo "<tr style='color:#fff;'>
                        <td>
                        <div class='form-check'>
                        <input type='checkbox' class='form-check-input'>
                        <label class='form-check-label' style='color:#fff;'>".$row["book_id"]."</label>
                        </div>
                        </td>
                        <td>".$row["book_name"]."</td>
                        ...
                        <div class='dropdown-menu dropdown-menu-right'>
                        <a class='dropdown-item' href='delete.php?delete_book=".$row["book_id"]."'><i class='fas fa-times text-orange-red'></i>Delete</a>
                        <a class='dropdown-item' href='view_books.php?view_book=".$row["book_id"]."'><i class='fas fa-cogs text-dark-pastel-green'></i>Edit</a>
                          </div>
                          </div>
                          </td>
                        </tr>";
