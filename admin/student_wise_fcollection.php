                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap" id="view_selected_student" style="color: #fff;">
     ...
     $("#assign_course_list").change(function () {
      ...
      $("#assign_accad_list").change(function () {
        ...
        console.log("sdsdsd"+selected_class)
            ...
            url : "action.php",
            method : "POST",
            data : {view_student:1,selectedclass:selected_class},
            success : function(data){
                $("#view_selected_student").html(data)
            }
        })
        });
        });
