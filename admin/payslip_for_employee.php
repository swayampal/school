...
<body>
        ...
        <div class="dashboard-page-one">
           ...
           ?>
            ...
            <div class="dashboard-content-one">
                ...
                <!-- view courses -->
                <?php
                $select_assign_course = "SELECT * from staff";
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap" id="staff" style="color: #fff;">
    ...
    // // staff table course,class,batch wise

    // $("#assign_course_list").change(function () {
    //     var val = $(this).val();
    //     var t_course =  $("#assign_course_list option:selected").val();
    //     console.log("sdsdsd"+t_course)
    //         $.ajax({
    //         url : "action.php",
    //         method : "POST",
    //         data : {t_course_wise:1,tcourse:t_course},
    //         success : function(data){
    //             $("#staff").html(data)
    //         }
    //     })
