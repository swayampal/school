...
if (isset($_POST["save"])) {
    ...
    $insert_guardian = "INSERT into gradian (first_name,middel_name,last_name,occupation,guardian_relation,address1,address2,city,post_code,phone_mobile,phone_emergency,adhar_no,email,adhar_id,active)values('$fname','$mname','$lname','$occupation','$relation','$address1','$address2','$city','$post_code','$phone','$phone_emergency','$adharno','$email','$IDimage','$status')";
    $run_query = mysqli_query($con,$insert_guardian);
    if($run_query){
    echo "<h1>done</h1>";
   ?>
                        ...
                        <form class="new-added-form" method="POST">
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="post_code">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Phone</label>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="Phone_emergency">
                                </div>
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Status *</label>
                                ...
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="adharno">
                                </div>
                                ...
                                <div class="col-lg-6 col-12 form-group mg-t-30">
                                    ...
                                    <input type="file" class="form-control-file" name="IDimage">
                                </div>
