...
if (isset($_POST["save"])) {
	...
	$insert_payroll_categries = "INSERT into lecture_time(lect_time)values('$time')";
        ...
        <div class="dashboard-page-one">
           ...
           <?php
            ...
            <div class="dashboard-content-one">
                        ...
                        <form class="new-added-form" method="POST">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    <label>Time*</label>
                                    <input type="text" placeholder="Categries Name" class="form-control" name="time">
                                </div>
                ...
                <!-- view courses -->
                <?php
                $select_lecture = "SELECT * from lecture_time";
                ...
                <div class="card height-auto">
                    ...
                    while ($row = mysqli_fetch_array($lecture_result)) {
                        ...
                        <label class='form-check-label' style='color:#fff;'>".$row["time_id"]."</label>
                        </div>
                        </td>
                        <td>".$row["lect_time"]."</td>
                        ...
                        <div class='dropdown-menu dropdown-menu-right'>
                        <a class='dropdown-item' href='delete.php?delete_payroll_categrie=".$row["time_id"]."'><i class='fas fa-times text-orange-red'></i>Delete</a>
                        <a class='dropdown-item' href='edit_payroll_categrie.php?edit_payroll_categrie=".$row["time_id"]."'><i class='fas fa-cogs text-dark-pastel-green'></i>Edit</a>
                        <a class='dropdown-item' href='student_details.php?view_student_id=".$row["time_id"]."'><i class='fas fa-redo-alt text-orange-peel'></i>view</a>
                          </div>
                          </div>
                          </td>
                        </tr>";
