...
$selected_course = "SELECT * from course where course_id = '$edit_id'";
$result_selected = mysqli_query($con,$selected_course);
$row_selected = mysqli_fetch_array($result_selected);
$course_name = $row_selected["course_name"];
$status = $row_selected["Active"];
?>
<!doctype html>
                        ...
                        <form class="new-added-form" method="POST">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="course_name" value="<?php echo $course_name;?>">
                                </div>
...
if (isset($_POST["update"])) {
	...
	$status = $_POST["status"];
	$upate_course = "UPDATE course set course_name = '$course_name',Active = '$status' where course_id = '$edit_id'";
	 $update_course_result = mysqli_query($con,$upate_course);
