...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <table class="table display data-table text-nowrap" id="students">
    ...
    <script type="text/javascript">
     ...
     $("#assign_batch").change(function(){
        var val = $(this).val();
        var batch = $("#assign_batch option:selected").val();
        console.log("helloooo"+batch)
        $.ajax({
            url : "action.php",
            method : "POST",
            data : {students:1,batch:batch},
            success :function(data){
                $("#students").html(data)
            }
        })
