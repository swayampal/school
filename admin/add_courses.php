...
if (isset($_POST["save"])) {
  ...
  $status = $_POST["status"];
  $save_course = "INSERT into course (course_name,Active)values('$course_name','$status')";
  $result_course = mysqli_query($con,$save_course);
  if ($result_course) {
        ...
        <div class="dashboard-page-one">
           ...
           <?php
            ...
            <div class="dashboard-content-one">
                        ...
                        <form class="new-added-form" method="POST">
                            <div class="row">
                                <div class="col-xl-3 col-lg-6 col-12 form-group">
                                    ...
                                    <input type="text" placeholder="" class="form-control" name="course_name">
                                </div>
                ...
                $select_course_result = mysqli_query($con,$select_all_course);
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table display data-table text-nowrap">
                                ...
                                <tbody>
                                    <?php
                    while ($row = mysqli_fetch_array($select_course_result)) {
                        echo "<tr style='color:#fff;'>
                        <td>
                        <div class='form-check'>
                        <input type='checkbox' class='form-check-input'>
                        <label class='form-check-label' style='color:#fff;'>".$row["course_id"]."</label>
                        </div>
                        </td>
                        ...
                        <div class='dropdown-menu dropdown-menu-right'>
                        <a class='dropdown-item' href='delete.php?delete_course=".$row["course_id"]."'><i class='fas fa-times text-orange-red'></i>Delete</a>
                        <a class='dropdown-item' href='edit_course.php?edit_course=".$row["course_id"]."'><i class='fas fa-cogs text-dark-pastel-green'></i>Edit</a>
                        <a class='dropdown-item' href='student_details.php?view_student_id=".$row["course_id"]."'><i class='fas fa-redo-alt text-orange-peel'></i>view</a>
                          </div>
                          </div>
                          </td>
                        </tr>";
