            ...
            <div class="dashboard-content-one">
                ...
                <div class="card height-auto">
                    <div class="card-body">
                        ...
                        ?>
                            <div class="item-img">
                                <a href="view_books.php?view_book=<?php echo $row["book_id"];?>"><iframe src="libary/<?php echo $row["pdf_file"];?>"></iframe></a>
                                <center> <a href="view_books.php?view_book=<?php echo $row["book_id"];?>"><p style="color: #fff;"><?php echo $row["book_name"];?></p></center>
                            </div>
                            <?php
                    }
                    ?>
