...
$insert_student = "INSERT into student(guardian_id,first_name,middle_name,last_name,gender,date_of_birth,phone,registration_date,academic_year,course_id,student_image)values('$gradian_id','$first_name','$middle_name','$last_name','$gender','$Date_0f_Birth','$phone','$register_date','$acc_year','$course_name','$image')";
